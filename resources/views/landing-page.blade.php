            ...
            <div class="bg-white p-6 md:p-10 rounded-xl shadow-2xl border border-blue-100 w-full max-w-xl">
                ...
                <form action="{{ route('guest.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                            <label class="block text-xs font-bold text-slate-600 mb-2 tracking-wide">Tanggal<span class="text-red-500">*</span></label>
                        ...
                        <div>
                            <label class="block text-xs font-bold text-slate-600 mb-2 tracking-wide">Jumlah Personil <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label class="block text-xs font-bold text-slate-600 mb-2 tracking-wide">Nama Lengkap (Perwakilan)<span class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label class="block text-xs font-bold text-slate-600 mb-2 tracking-wide">Asal Instansi<span class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label class="block text-xs font-bold text-slate-600 mb-2 tracking-wide">Nomor HP / Email <span class="text-red-500">*</span></label>
                        <input type="text" name="kontak" placeholder="Contoh: 081234567890 / email@gmail.com" required class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:bg-white transition outline-none text-sm font-medium">
                    </div>

                    <div>
                        <label class="block text-xs font-bold text-slate-600 mb-2 tracking-wide">Bertemu Siapa? <span class="text-red-500">*</span></label>
                        <div class="relative">
                    ...
                    <div>
                        <label class="block text-xs font-bold text-slate-600 mb-2 tracking-wide">Keperluan <span class="text-gray-400 font-normal normal-case">(Singkat saja)</span> <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        ...
                        <div class="flex flex-col gap-3">
                            <input type="file" id="input_foto_file" name="foto" accept="image/*" class="hidden" onchange="previewFile()">
                            <div class="border-2 border-dashed border-slate-300 rounded-xl p-4 bg-slate-50 text-center relative group min-h-[150px] flex flex-col items-center justify-center">
            ...
            <div class="bg-white rounded-2xl shadow-xl border border-blue-100 overflow-hidden" id="tabel-kunjungan">
                ...
                <div class="p-6 border-b border-blue-50 flex flex-col xl:flex-row justify-between items-center gap-4">
                    <div class="flex items-center gap-3 w-full xl:w-auto">
                        ...
                        <span id="loading-indicator" class="hidden text-xs font-bold text-blue-500 animate-pulse">Sedang mencari...</span>
                    </div>
                    ...
                    <div class="flex flex-col md:flex-row items-center gap-2 w-full xl:w-auto">
                        ...
                        <div class="flex gap-2 w-full md:w-auto">
                            <select id="filter_bulan" class="w-1/2 md:w-auto px-3 py-2 border border-slate-200 rounded-lg text-sm bg-slate-50 focus:ring-2 focus:ring-blue-500 outline-none cursor-pointer">
                        ...
                        <button onclick="resetFilters()" class="bg-slate-200 hover:bg-slate-300 text-slate-600 px-3 py-2 rounded-lg text-sm font-bold transition border border-slate-300" title="Reset">
                            ↺
                        </button>
                    </div>
                </div>
