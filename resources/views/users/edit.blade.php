        ...
        <div class="bg-white p-8 rounded-3xl shadow-xl border border-blue-50 w-full max-w-lg">
            ...
            <form action="{{ route('users.update', $user->id) }}" method="POST" class="space-y-5">
                ...
                <div class="bg-yellow-50 p-4 rounded-xl border border-yellow-100">
                    ...
                    <div class="relative">
                        <input type="password" name="password" id="password"
                            ...
                            class="w-full px-4 py-3 bg-white border border-yellow-200 rounded-xl focus:ring-2 focus:ring-yellow-500 outline-none pr-12">
                        <button type="button" id="togglePassword"
                            class="absolute inset-y-0 right-0 pr-3.5 flex items-center text-yellow-600 hover:text-yellow-700 focus:outline-none transition-all duration-200">
                ...
                <div class="flex gap-3 pt-4">
                    ...
                    <button type="submit"
                        class="w-1/2 bg-blue-900 text-white font-bold py-3 rounded-xl hover:bg-blue-800 transition shadow-lg">Update
                        Data</button>
                </div>
            </form>
